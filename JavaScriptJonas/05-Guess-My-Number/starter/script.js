...
// refactoring the document.querySelector('.message').textContent into a function
...
document.querySelector('.check').addEventListener('click', function () {
  ...
  if (!guess) {
    ...
    ///////////////////////////////
    ///// Refactoring the code, Jonas
    ///////////////////////////////

    // the code is almost the same when th guess is above or below than the secret except for the string ...

    // in both cases when the guess is high or low that is different than the secret number

    // We unified these two conditions
  } else if (guess !== secretNumber) {
    if (score > 1) {
